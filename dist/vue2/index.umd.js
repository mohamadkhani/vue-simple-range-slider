...
;// CONCATENATED MODULE: ./node_modules/@vue/vue-loader-v15/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!../components/simpleRangeSlider.vue?vue&type=template&id=46b273aa&scoped=true&
...
/* harmony default export */ var simpleRangeSlidervue_type_script_lang_ts_setup_true_ = (/*#__PURE__*/(0,external_commonjs_vue_commonjs2_vue_root_Vue_.defineComponent)({
    ...
    setup(__props, { emit }) {
        ...
        const iValue = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.computed)({
            get: () => {
                console.log('isVue', ({"NODE_ENV":"production","BASE_URL":"/"})?.ISVUE2);
                console.log('env', ({"NODE_ENV":"production","BASE_URL":"/"}));
                if (isVue2)
                    return props.value;
                else
